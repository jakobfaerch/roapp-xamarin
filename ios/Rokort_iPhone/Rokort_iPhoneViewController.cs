	...
	public partial class Rokort_iPhoneViewController : UIViewController
	{
		...
		class ContentForRequest
		{
			public ContentForRequest() {
				...
				StartDateTime = "21-01-2014 15:15";
				EndDateTime = "";
				Distance = "";
				Rower_list = "~" + RowerId;
			...
			public HttpContent build()
			{
				var formValues = new List<KeyValuePair<string, string>> {
					...
					new KeyValuePair<string, string> ("xStartDateTime", xStart),
					new KeyValuePair<string, string> ("xEndDateTime", xEnd),
					...
					new KeyValuePair<string, string> ("StartDateTime", StartDateTime),
					new KeyValuePair<string, string> ("EndDateTime", EndDateTime),
